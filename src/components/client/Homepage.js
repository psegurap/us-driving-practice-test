...
import InstruccionesDialog from "@/components/client/InstruccionesDialog";
...
export default function Homepage() {
    ...
    return (
        <>
            <div className="bg-white py-12 sm:py-24 dark:bg-gray-900">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:text-center">
                        <h2 className="text-base/7 font-semibold text-gray-500 dark:text-indigo-400">
                            Examen Teórico
                        </h2>
